...
\begin{enumerate}
    ...
    \item Laufe Kante für Kante rückwärts durch den Kontrollflussgraphen, beginnend bei der zu untersuchenden Leseoperation.
        \begin{enumerate}
            ...
            Hinzugefügt wird die neue Quelle zusammen mit 1) der momentanen Ordnung als Bedingung und 2) den Bedingungen der umgebenden if-else-Verzweigungen (die rückwärts betreten und bisher noch nicht verlassen wurden).
        ...
        \end{enumerate}
    \item Der Algorithmus terminiert, sobald für kein Indextupel $(i,j)$ mehr $\bot$ als Quelle auftritt, oder das Programmende erreicht wurde.
\end{enumerate}
